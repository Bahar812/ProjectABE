...
const NavbarPos = () => {
  ...
  const { pesanan, total, uuidTransaction } = useSelector(
  ...
  const kembaliKeList = async(total) =>{
    console.log("uuid" + uuidTransaction);
    ...
    <div>
      ...
      <nav className="navbar  is-fixed-top has-shadow" role="navigation" aria-label="main navigation">
        <div className="navbar-brand">
            <button className='button is-danger ml-6 mt-2' onClick={() => kembaliKeList(total)}> back </button>
